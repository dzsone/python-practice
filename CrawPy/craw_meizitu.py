...
class mzitu():
    ...
    def mkdir(self, path):  ##这个函数创建文件夹
        path = path.strip()
        isExists = os.path.exists(os.path.join(r"E:\test\python edit\CrawPy\mzitu", path))
        if not isExists:
            print(u'建了一个名字叫做', path, u'的文件夹！')
            os.makedirs(os.path.join(r"E:\test\python edit\CrawPy\mzitu", path))
            os.chdir(os.path.join(r"E:\test\python edit\CrawPy\mzitu", path))  ##切换到目录
            return True
        else:
